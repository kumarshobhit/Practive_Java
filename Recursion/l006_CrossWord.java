public class l006_CrossWord {
    ...
    //    if(c == 0 && c+l<10 && box[r][c+l] != '+') return false ;
    //    if(c!=0 && c+l == 10 && box[r][c-1] != '+') return false ;
    //    if(c!=0 && c+l!=10 && box[r][c-1] != '+' || box[r][c+l] != '+') return false ;
    ...
    for (int i = 0; i < 10 && c + i < word.length(); i++) {
    ...
    public static boolean isPossiblePlaceV(int r, int c, String word) {
        ...
        for (int i = 0; i < 10 && r + i < word.length(); i++) {
